...
type ModalType = 'load' | 'copycss' | 'download' | 'keybindings' | 'preview' | null;
...
export default class App extends Component<AppProps, AppState> {
  ...
  constructor(props: AppProps) {
    ...
    Object.assign(drawHandlersProvider(this as any));
  ...
  changeModalType(type: ModalType) {
    this.setState({ helpOn: false, modalType: type, modalOpen: true });
  }

  closeModal() {
    this.setState({ modalType: undefined, helpOn: false, modalOpen: false });
  }
